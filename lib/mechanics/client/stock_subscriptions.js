...
class StockSubscribitionsController extends MechanicsController {
    /**
    ...
    getSubscribedStocks() {
        ...
        var allWhereIdInSubscriptions = {
            _id: {$in: this.model.stocks}
        };

        return new Promise(function(resolve, reject) {
            Stock.findAndPopulate(allWhereIdInSubscriptions, (err, stocks) => {
    ...
    /**
     * Сохраняет изменения в модели клиента
     * @returns {Promise}
     */
    saveChanges() {
        var self = this;
